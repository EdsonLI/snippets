...
$(document).ready(function() {
  ...
  const state = {
    ...
    'ai': ['commands_copilot_vscode.html', 'context_variables_copilot_vscode.html', 'github-copilot.html', 'instructions_copilot_vscode.html'],
    'bootstrap': ['snippet_bootstrap_form_validation.html'],
    'css': ['snippet_css_display_flex_center.html'],
    'dev-utils': ['dev-utils.html'],
    'git': ['snippet_git_change_all_message_commits.html', 'snippet_git_conflict_resolution_vscode.html', 'snippet_git_local_to_overwrite_remote.html', 'snippet_git_merge_x_rebase.html', 'snippet_git_reset_hard_foce_push.html', 'snippet_git_stash.html', 'snippet_git_update_local_branch_from_development_and_other.html', 'snippet_git_update_local_branch_from_remote_development.html'],
    ...
    // Última atualização: 06/09/2025 18:55:08
  };
