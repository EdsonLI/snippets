  ...
  function transformTechBadges() {
    ...
    techSpans.forEach(span => {
      ...
      // Caso especial para W3Schools - usar um SVG customizado com wrapper
        ...
        // Criar um elemento para o ícone SVG do W3Schools
        const w3schoolsIcon = document.createElement('span');
        w3schoolsIcon.className = 'w3schools-icon tech-icon-custom';
        w3schoolsIcon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 50.8" width="16" height="16">
          <defs>
            <clipPath id="w3schools-clip0">
              <rect width="37.2768" height="35" fill="white"/>
            </clipPath>
          </defs>
          <g clip-path="url(#w3schools-clip0)" transform="matrix(1.451231002808, 0, 0, 1.451231002808, -0.053854331374, -2.645e-9)">
        ...
        // Adicionar o ícone ao wrapper e o wrapper ao span
        iconWrapper.appendChild(w3schoolsIcon);
        span.insertBefore(iconWrapper, span.firstChild);
      }
