...
document.addEventListener('DOMContentLoaded', function() {
  ...
  setTimeout(function() {
    ...
    const phpSvgContent = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 80" class="php-icon-svg">
        <rect width="150" height="80" rx="5" fill="white"/>
        <g transform="matrix(.164883 0 0 -.162632 11.737077 58.329876)">
          <defs>
            ...
            <radialGradient cx="0" cy="0" fx="0" fy="0" gradientTransform="matrix(363.05789,0,0,-363.05789,177.52002,256.30713)" gradientUnits="userSpaceOnUse" id="php-B" r="1" spreadMethod="pad">
          ...
          <g clip-path="url(#php-A)">
            <path d="M11.52 162C11.52 81.677 135.307 16.56 288 16.56S564.48 81.677 564.48 162 440.693 307.44 288 307.44 11.52 242.322 11.52 162" fill="url(#php-B)"/>
          </g>
          <g clip-path="url(#php-C)">
