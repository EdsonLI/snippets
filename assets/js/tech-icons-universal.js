...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const techIcons = {
    ...
    // W3Schools
    'w3schools': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 326.1" class="w3schools-icon-svg">
      <style type="text/css">.st0{fill:#04AA6D;}</style>
      <g id="g869">
        <path id="path832" class="st0" d="M269.2,130l109.8,196l54.4-96.8l-104-185H209l-50.1,89.1l-50.1-89.1H0l158,281.8l1-1.4l0.5,1.4L269.2,130z"/>
        <path id="path1166" class="st0" d="M431.6,101.1l3.9,3.9c3.5,2.6,7.2,4.7,11.1,6.3c5.5,2.6,10.8,3.9,15.9,3.9c7.1,0,12.9-1.9,17.6-5.8c4.7-3.9,7-8.7,7-14.4c0-7.1-2.7-12.4-8.2-15.9c-5.5-3.5-12.4-5.3-20.7-5.3h-9.6l-5.3-12.5l24.6-29.9c2.2-2.6,4.7-5,7.2-7.2l2.9-2.9h-53V0h83.3v15.4l-33.2,38.5c10.3,1.6,18.8,5.6,25.5,12c7.7,7.4,11.6,16.7,11.6,27.9c0,12.2-4.2,22.5-12.5,30.8c-9,9.3-20.7,14-35.2,14c-8.7,0-16.9-1.6-24.6-4.8c-5.8-2.2-10.9-5.1-15.4-8.7l-5.3-4.8L431.6,101.1z"/>
      </g>
    </svg>`,
